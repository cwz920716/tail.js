...
const wrapMe = require('wrapMe').wrapMe;
const setContext = require('wrapMe').setContext;
const resetContext = require('wrapMe').resetContext;
...
ServerResponse.prototype._uv_setup = function(socket, reqId) {
  this.uvSetup = true;
  this.socket = socket;
  this.urid = reqId;
}
...
function Server(requestListener) {
  requestListener = wrapMe(requestListener, false);
  ...
  function parserOnIncoming(req, shouldKeepAlive) {
    ...
    if (req.headers.expect !== undefined &&
      ...
      if (EventEmitter.listenerCount(self, 'checkContinue') > 0) {
        ...
        res.writeContinue();
        console.log('socket: ' + socket._handle.uv_request());
        setContext(req);
