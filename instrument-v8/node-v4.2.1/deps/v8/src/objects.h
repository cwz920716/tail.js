...
class JSObject: public JSReceiver {
 ...
 private:
  ...
  friend class Object;
  friend void instrument::createFunction(internal::Handle<internal::JSFunction> handle);
  friend bool instrument::enterFunction(internal::Handle<internal::JSFunction> handle);
  friend bool instrument::exitFunction(internal::Handle<internal::JSFunction> handle);
