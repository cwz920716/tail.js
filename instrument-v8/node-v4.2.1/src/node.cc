...
using v8::instrument::FunctionWrap;
...
int Start(int argc, char** argv) {
  ...
  V8::Initialize();
  // start instrument preparation
  FunctionWrap::setCreateFunHook(instrument::createFunHandler);
  FunctionWrap::setBeforeCallHook(instrument::beforeCallHandler);
  FunctionWrap::setAfterCallHook(instrument::afterCallHandler);
